...
public class DecaledObject : MonoBehaviour {
	...
	public void AddDecalProjector(Ray a_Ray, RaycastHit a_RaycastHit) {
		AddDecalProjector(a_RaycastHit.point, a_Ray.direction, a_RaycastHit.collider);
	}

	public void AddDecalProjector(Vector3 point, Vector3 dir, Collider collider, int type = 0) {
